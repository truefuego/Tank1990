    ...
    public void paint(Graphics g)
    {
        ...
        if(play)
        {
            ...
            if((player1Bullet != null) && player1Shoot)
            {
                ...
                if(new Rectangle(player2X, player2Y, 50, 50)
                        .intersects(new Rectangle(player1Bullet.getX(), player1Bullet.getY(), 10, 10)))
                {
                    player1score += 10;
                    player2lives -= 1;
                    player1Bullet = null;
                ...
                if ((player1Bullet != null) && br.checkCollision(player1Bullet.getX(), player1Bullet.getY())) {
                    ...
                    player1Shoot = false;
                    bulletShootDir1 = "";
                } else if ((player1Bullet != null) && br.checkSolidCollision(player1Bullet.getX(), player1Bullet.getY())) {
                    player1Bullet = null;
                    player1Shoot = false;
                    bulletShootDir1 = "";
                }
        ...
        g.setFont(new Font("Atari",Font.BOLD, 15));
        ...
        {
            g.setColor(Color.white);
            g.setFont(new Font("Atari",Font.BOLD, 60));
    ...
    private class Player1Listener implements KeyListener
    {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if(e.getKeyCode()== KeyEvent.VK_W)
            {
                ...
                if(br.canMove(player1X,player1Y,"up")) {
                    if (player1Y > 10) {
                        player1Y -= 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_A)
            {
                ...
                if(br.canMove(player1X,player1Y,"left")) {
                    if (player1X > 10) {
                        player1X -= 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_S)
            {
                ...
                if(br.canMove(player1X,player1Y,"down")) {
                    if (!(player1Y > 540)) {
                        player1Y += 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_D)
            {
                ...
                if(br.canMove(player1X,player1Y,"right")) {
                    if (!(player1X > 590)) {
                        player1X += 10;
                    }
                }
    ...
    private class Player2Listener implements KeyListener
    {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if(e.getKeyCode()== KeyEvent.VK_UP)
            {
                ...
                if(br.canMove(player2X,player2Y,"up")) {
                    if (!(player2Y < 10)) {
                        player2Y -= 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_LEFT)
            {
                ...
                if(br.canMove(player2X,player2Y,"left")) {
                    if (!(player2X < 10)) {
                        player2X -= 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_DOWN)
            {
                ...
                if(br.canMove(player2X,player2Y,"down")) {
                    if (!(player2Y > 540)) {
                        player2Y += 10;
                    }
                }
            ...
            if(e.getKeyCode()== KeyEvent.VK_RIGHT)
            {
                ...
                if(br.canMove(player2X,player2Y,"right")) {
                    if (!(player2X > 590)) {
                        player2X += 10;
                    }
                }
